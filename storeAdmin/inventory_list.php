...
//this block grabs the whole list for viewing
	...
	if($productsCount>0)
	{
			...
			while($row = mysql_fetch_array($sql))
			{
				...
				$product_list.="$date_added-$id-$product_name&nbsp;&nbsp;&nbsp;&bull;<a href = 'inventory_list.php?deleteid=$id'>delete</a><br/>";
...
<p>&nbsp;</p>
<p><a href="../indexza.php">View Product Added</a></p>
...
<table width="90%" border="0" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <option value="Electronics">Tekkies</option>
    </select>
    </label>
    </td>
  </tr>
