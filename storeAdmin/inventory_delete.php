...
if(isset($_GET['yesdelete']))
{
	...
	$sql = mysql_query("DELETE FROM products ");
...
//me
if(isset($_GET['deleteid'])){
 echo 'Do you really want to delete with ID of'. $_GET['deleteid'.'? <a href="inventory_list.php?yesdelete='. $_GET['delete'].'">Yes</a>|<a href="inventory_list.php">No</a>'];	
 exit();
